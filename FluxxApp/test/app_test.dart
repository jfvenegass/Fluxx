...
void main() {
  ...
  group('App Integration Tests', () {
    testWidgets('Muestra el diálogo de confirmación y prueba las acciones',
      ...
      expect(find.text('¿Deseas añadir los puntos diarios al total?'),
          findsOneWidget);
    ...
    testWidgets('Verifica que se muestra correctamente el ítem seleccionado',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'Verifica que el callback onAddButtonPressed se llama al seleccionar el botón "Añadir"',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'Verifica que el callback onItemTapped se llama correctamente al seleccionar otros ítems',
        (WidgetTester tester) async {
      int tappedIndex = -1;
    ...
    testWidgets('Muestra el porcentaje correcto en el centro del indicador',
        (WidgetTester tester) async {
    ...
    testWidgets('Clampa el valor de progreso entre 0.0 y 1.0',
        (WidgetTester tester) async {
    ...
    testWidgets('Verifica el color y la configuración del indicador',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
      ...
      final circularPercentIndicator = tester.widget<CircularPercentIndicator>(
    ...
    testWidgets('Muestra el ícono de fuego y el número de la racha correctamente',
        (WidgetTester tester) async {
    ...
    testWidgets('Verifica el estilo de texto del número de la racha',
        (WidgetTester tester) async {
    ...
    testWidgets('Muestra el mensaje de bienvenida y el botón "Comenzar"',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: WelcomeScreen(),
    ...
    testWidgets(
        'Navega a la pantalla de inicio de sesión al presionar el botón "Comenzar"',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          initialRoute: '/',
